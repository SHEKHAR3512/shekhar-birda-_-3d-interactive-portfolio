...
[![Firebase Realtime](https://img.shields.io/badge/Firebase-Realtime_DB-FFCA28?style=for-the-badge&logo=firebase&logoColor=black)](https://firebase.google.com/)
...
flowchart TD
    subgraph Client["Client Browser (React 19 + TypeScript)"]
        ...
        ThreeCanvas["Three.js 3D Cosmos Engine\n(Starfighter, Planets, Stardust, GSAP)"]
        ...
        PhysicsTuner["Live Antigravity Physics Tuner\n(Velocity, Thrust, Turn Rate)"]
    ...
    subgraph BackendServices["Backend & Serverless Layer"]
        VercelAPI["Vercel Edge Functions (/api/chat, /api/health)"]
        ExpressLocal["Local Express 4 Dev Server (server.ts)"]
        GeminiAI["Google Gemini 2.5 Flash (@google/genai)"]
        OfflineKB["Grounded Offline Knowledge Fallback"]
        FirebaseDB["Google Firebase (Firestore & Analytics)"]
    end

    HUDView -- "AI Prompts" --> VercelAPI
    HUDView -- "AI Prompts (Local)" --> ExpressLocal
    VercelAPI --> GeminiAI
    ExpressLocal --> GeminiAI
    GeminiAI -- "Fallback on Rate Limit" --> OfflineKB
...
[![Email](https://img.shields.io/badge/Email-shekharbirda@gmail.com-EA4335?style=for-the-badge&logo=gmail&logoColor=white)](mailto:shekharbirda@gmail.com)
