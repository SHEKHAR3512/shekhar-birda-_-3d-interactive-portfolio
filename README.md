...
[![Babylon.js 9](https://img.shields.io/badge/Babylon.js-9.27_WebGL3D-BB464B?style=for-the-badge&logo=babylon.js&logoColor=white)](https://www.babylonjs.com/)
...
[![Firebase Firestore](https://img.shields.io/badge/Firebase-Firestore_%26_Analytics-FFCA28?style=for-the-badge&logo=firebase&logoColor=black)](https://firebase.google.com/)
...
flowchart TD
    subgraph Client["Client Browser (React 19 + TypeScript)"]
        UI["App Container (Viewport Locked)"]
        BabylonCanvas["Babylon.js 9 Cosmos Engine\n(Starfighter, GLB Planets, Stations, PBR)"]
        HUDView["Starfighter Cockpit HUD\n(Telemetry, Speed, Radar, Target Lock)"]
        ExecView["2D Executive Resume Mode\n(Smooth Ref Scroll, Metrics, Projects)"]
        SupportPortal["Customer Support Portal (/support)\n(Ticket Creator, WhatsApp Fallback)"]
        SupportAdmin["Support Admin Console (/support/admin)\n(Passcode Auth, Ticket Triaging)"]
    ...
    subgraph BackendServices["Backend & Serverless Layer"]
        VercelAPI["Vercel Serverless Functions (/api/*)"]
        ExpressLocal["Local Express 4 Dev Server (server.ts)"]
        GeminiAI["Google Gemini 2.5 Flash (@google/genai)"]
        EmailService["Live Gmail SMTP (nodemailer)"]
        FirebaseDB["Google Firebase (Firestore & Analytics)"]
    end

    HUDView -- "AI Chat" --> VercelAPI
    HUDView -- "AI Chat (Local)" --> ExpressLocal
    SupportPortal -- "Create Ticket" --> FirebaseDB
    SupportPortal -- "Dispatch Alert" --> EmailService
    SupportAdmin -- "Passcode Auth" --> VercelAPI
    SupportAdmin -- "Realtime Tickets" --> FirebaseDB
    ExecView -- "Guestbook Endorsements" --> FirebaseDB
    VercelAPI --> GeminiAI
```
...
[![LinkedIn](https://img.shields.io/badge/LinkedIn-Shekhar_Birda-0077B5?style=for-the-badge&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/shekhar-birda-279763353/)
[![GitHub](https://img.shields.io/badge/GitHub-SHEKHAR3512-181717?style=for-the-badge&logo=github&logoColor=white)](https://github.com/SHEKHAR3512)
[![WhatsApp](https://img.shields.io/badge/WhatsApp-Chat_Now-25D366?style=for-the-badge&logo=whatsapp&logoColor=white)](https://wa.me/919996231869)
[![Phone](https://img.shields.io/badge/Phone-+91_9996231869-34A853?style=for-the-badge&logo=google-phone&logoColor=white)](tel:+919996231869)
[![Email](https://img.shields.io/badge/Email-shekharjaat751@gmail.com-EA4335?style=for-the-badge&logo=gmail&logoColor=white)](mailto:shekharjaat751@gmail.com)
